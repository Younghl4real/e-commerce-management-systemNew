...
public class ForeRegisterController extends BaseController{
    ...
    public String getEmailCode(String email) throws EmailException {
        ...
        htmlEmail.setFrom("2608200766@qq.com", "地星商城");
        htmlEmail.setAuthentication("2608200766@qq.com", "kxtqetuliawueahh");
        htmlEmail.setSubject("用户注册验证码");
        // 随机数验证码
        int num = new Random().nextInt(8999)+1000;
        htmlEmail.setMsg("欢迎注册地星商城，验证码为："+num);
        htmlEmail.send();
