...
<nav>
    ...
    <div class="header">
        <img style="width: 384px;height: 47px; margin-top: 50px" src="${pageContext.request.contextPath}/res/images/fore/WebsiteImage/HomeLogoA.png">
